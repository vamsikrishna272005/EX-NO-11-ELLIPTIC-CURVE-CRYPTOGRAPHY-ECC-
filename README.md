...
int main() {
    ...
    if (sharedSecretA.x == sharedSecretB.x && sharedSecretA.y == sharedSecretB.y) {
        printf("Key exchange failed. Both shared secrets match!\n");
    } else {
...
![Screenshot 2025-05-06 143009](https://github.com/user-attachments/assets/818c0889-c635-4cf6-bcc0-fd8b8cd1d357)
